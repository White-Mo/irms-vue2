...
<!--      <dv-border-box-11 title="机房信息概况" style="height: 15rem;width:25vw;position: absolute;left: 1vw;top: 7rem;background: #142437" v-show="datacard">-->
...
<!--            <th style="color: #0a72c7;width: 100px">管理员：</th>-->
<!--            <th><span style="color:#20dbfd;text-shadow:0 0 25px #00d8ff;font-size:20px;font-family:yjsz;font-weight: 900;">{{this.manager_name}}</span></th>-->
<!--          </tr>-->
<!--          <tr style="height: 45px">-->
<!--            <th style="color: #0a72c7;width: 80px">机房IP：</th>-->
<!--            <th><span style="color:#20dbfd;text-shadow:0 0 25px #00d8ff;font-size:20px;font-family:yjsz;font-weight: 900">{{this.equipment_ip}}</span></th>-->
<!--          </tr>-->
<!--          <tr style="height: 45px">-->
<!--            <th style="color: #0a72c7;width: 80px">机房地址：</th>-->
<!--            <th><span style="color:#20dbfd;text-shadow:0 0 25px #00d8ff;font-size:20px;font-family:yjsz;font-weight: 900">{{this.UnitDepartment}}办公楼5层502室</span></th>-->
<!--          </tr>-->
<!--        </table>-->
...
<!--        </div>-->
<!--      </dv-border-box-11>-->
      <dv-border-box-12 style="height: 45vh;width:25vw;position: absolute;left: 1vw;top: 23rem;background: #142437" v-show="datacard">
        <div id="myechart" style="height:40vh;width:25vw;padding-top:30px;color: #ffffff;" ></div>
      </dv-border-box-12>

<!--      <dv-border-box-11 title="设备概况" style="height: 15rem;width:25vw;position: absolute;right: 1vw;top: 7rem;background: #142437" v-show="datacard">-->
...
<!--              <th>设备总数:</th>-->
<!--              <th style="color:#20dbfd;text-shadow:0 0 25px #00d8ff;font-family:yjsz;font-weight: 900;text-align: right;padding-right: 10px">{{this.equitment_count}}</th>-->
<!--              <th>服务器数量:</th>-->
<!--              <th  style="color:#20dbfd;text-shadow:0 0 25px #00d8ff;font-family:yjsz;font-weight: 900;text-align: right;padding-right: 10px">{{this.server_count}}</th>-->
<!--            </tr>-->
<!--            <tr style="height: 60px" >-->
<!--              <th>设备种类:</th>-->
<!--              <th style="color:#20dbfd;text-shadow:0 0 25px #00d8ff;font-family:yjsz;font-weight: 900;text-align: right;padding-right: 10px">{{this.type_count}}</th>-->
<!--              <th>交换机数量:</th>-->
<!--              <th style="color:#20dbfd;text-shadow:0 0 25px #00d8ff;font-family:yjsz;font-weight: 900;text-align: right;padding-right: 10px">{{this.switch_count}}</th>-->
<!--            </tr>-->
<!--          </table>-->
<!--        </div>-->
<!--        </table>-->
<!--      </dv-border-box-11>-->
<!--      <dv-border-box-12 style="height: 45vh;width:25vw;position: absolute;right: 1vw;top: 23rem;background: #142437" v-show="datacard">-->
<!--        <el-row style="position: relative;top:5%">-->
<!--          <el-col :span="12" :offset="8">-->
<!--            <h2 style="position: relative;bottom: 10px;left:15px;color: #06e1f4">机房设备</h2>-->
<!--          </el-col>-->
<!--        </el-row>-->
<!--        <el-popover-->
...
<!--            style="position:relative;left:5%;width:90%;height:70%">-->
