        ...
        <el-dialog title="新增一级设备类型" :visible.sync="dialogFormVisible">
          <el-form :model="form">
            <el-form-item label="一级设备类型名称" :label-width="formLabelWidth">
              <el-input v-model="form.equipmentFirstTypeName" auto-complete="off"></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    // 综合数据管理展示与查询&#45;&#45;lry
    fetchData() {
      // //每次添加后把equipmentFirstTypeName，equipmentFirstTypeCode置空
      // this.equipmentFirstTypeName = ''
      // this.equipmentFirstTypeCode = ''
    ...
    handleDelete(index, row) {
      ...
      this.$alert(`是否永久删除:\"${row.equipmentFirstTypeName}\"设备类型`, '提示', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning',
