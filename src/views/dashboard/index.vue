...
// 点击饼状图，重新加载其他图表
    ...
    mapInit() {
      ...
      //     },
      //     itemStyle: {
      //       areaColor: '#f5f5f5', // 设置地图区域颜色
      //       borderColor: '#fff', // 设置地图边界线颜色
      ...
      // });
      myChart.showLoading();
      // 使用ajax获取Geoserver图层数据
      let params={
        service: 'WFS',
        version: '1.0.0',
        request: 'GetFeature',
        typeName: 'ktw:zhongguoxingzhengquyujiexian', //Geoserver图层名称
        maxFeatures: '50',
      ...
      getMapJson(params).then(response => {
        ...
        // echarts.registerMap('world', response); // 注册地图数据
      }).catch(error => {
          console.log(error)
        })
